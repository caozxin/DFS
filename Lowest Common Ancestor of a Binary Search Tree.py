...
class Solution:
    ...
    """
    def lowestCommonAncestor_01(self, root, p, q): # this should work for binary tree search alone, but need to debug it!
    ...
    def lowestCommonAncestor(self, root, p, q): # this solution applies for LCA of a binary tree too
